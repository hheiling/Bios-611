...
1.  What's gone wrong with this code? Why are the points not blue?
    ...
    Answer: You would need to put the 'color = "blue"' outside of the aes section
...
2.  Which variables in `mpg` are categorical? Which variables are continuous? 
    ...
    Continuous: Displ, Year, Cyl, Cry, Hwy
    When you run 'mpg', the designation of 'chr' indicates a character variable, which will all be categorical. The other designations of 'dbl' and 'int' indicate numerica variables, which will be continuous.
...
6.  What happens if you map an aesthetic to something other than a variable 
    ...
    Answer: It splits the data into two sections and colors them differently; one color for those that evaluate "displ < 5" as true and one color for those that evaluate "displ < 5" as false.
...
1.  What do the empty cells in plot with `facet_grid(drv ~ cyl)` mean?
    ...
    Answer: It means that there were no points that were in both the specific drv and cyl combinations
